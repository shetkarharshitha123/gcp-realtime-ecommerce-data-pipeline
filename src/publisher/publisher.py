...
# Public E-Commerce API (Random Carts/Orders)
API_BASE_URL = "https://fakestoreapi.com/carts"

def fetch_and_publish():
    try:
        # Fetch a random cart order (ID 1 through 7)
        ...
        print(f"Published Order Cart ID #{cart_id} to Pub/Sub. Message ID: {future.result()}")
...
if __name__ == "__main__":
    ...
    while True:
        fetch_and_publish()
        time.sleep(5)  # Fetch new order every 5 seconds
